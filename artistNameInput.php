...
$DBArtistSet =  $conn->getAllArtistNames();

$customizedArtistSet = array();

foreach($DBArtistSet as $artist){
    $customizedArtistSet[$artist['artist']] = 1;
}

$unionSet = $basicArtistSet + $customizedArtistSet;

$keys = array_keys($unionSet);
